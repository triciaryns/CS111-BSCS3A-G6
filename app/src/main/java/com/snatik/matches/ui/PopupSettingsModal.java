...
public class PopupSettingsModal extends LinearLayout {

	private ImageView mSoundImage;
	private TextView mSoundText;

	public PopupSettingsModal(Context context) {
		this(context, null);
	}

	public PopupSettingsModal(Context context, AttributeSet attrs) {
		super(context, attrs);
		setOrientation(LinearLayout.VERTICAL);
		setBackgroundResource(R.drawable.settings_modal);
	...
	private void setMusicButton() {
		if (Music.OFF) {
			...
			mSoundImage.setImageResource(R.drawable.music_off);
		} else {
			mSoundText.setText("Sound ON");
			mSoundImage.setImageResource(R.drawable.music_on);
		}
	}
}
