...
public class LevelCompletedModal extends RelativeLayout {
	...
	public LevelCompletedModal(Context context) {
		this(context, null);
	}

	public LevelCompletedModal(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		setBackgroundResource(R.drawable.level_completed);
