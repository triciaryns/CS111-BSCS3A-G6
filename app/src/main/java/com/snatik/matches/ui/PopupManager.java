...
public class PopupManager {
	...
	public static void showPopupSettings() {
		...
		// popup
		PopupSettingsModal popupSettingsModal = new PopupSettingsModal(Shared.context);
		...
		popupContainer.addView(popupSettingsModal, params);

		// animate all together
		ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(popupSettingsModal, "scaleX", 0f, 1f);
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(popupSettingsModal, "scaleY", 0f, 1f);
	...
	public static void showPopupWon(GameState gameState) {
		...
		// popup
		LevelCompletedModal levelCompletedModal = new LevelCompletedModal(Shared.context);
		levelCompletedModal.setGameState(gameState);
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(width, height);
		params.addRule(RelativeLayout.CENTER_IN_PARENT);
		popupContainer.addView(levelCompletedModal, params);

		// animate all together
		ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(levelCompletedModal, "scaleX", 0f, 1f);
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(levelCompletedModal, "scaleY", 0f, 1f);
		AnimatorSet animatorSet = new AnimatorSet();
		animatorSet.playTogether(scaleXAnimator, scaleYAnimator);
		animatorSet.setDuration(500);
		animatorSet.setInterpolator(new DecelerateInterpolator(2));
		levelCompletedModal.setLayerType(View.LAYER_TYPE_HARDWARE, null);
		animatorSet.start();
	}
